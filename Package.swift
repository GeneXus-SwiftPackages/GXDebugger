...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDebugger-1.0.0-beta+20230328171001.xcframework.zip",
			checksum: "0b374f4a855c96ee4d7bdf3cce812affe345da6138a02abffacdf60e914d1ada"
		)
	]
)