...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-3.2.0-rc.12.xcframework.zip",
			checksum: "1b8869e881a22f08992f83a53932515457b09a294b7d1f6d522b63053cd77235"
		)
	]
)