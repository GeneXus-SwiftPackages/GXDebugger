...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDebugger-1.0.0-beta+20230323104412.xcframework.zip",
			checksum: "cb5dd370278cb66aed0f5962dc3cb8e61cc59b35928df64d5b1a1974750671f6"
		)
	]
)