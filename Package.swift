...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDebugger-1.0.0-beta.20230620165651.xcframework.zip",
			checksum: "090a5f2c50f26ef26498ecdef26e9f2ab42d4d2c32cbda023b79b7f51cf5b85d"
		)
	]
)