...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-2.0.0-rc.22.xcframework.zip",
			checksum: "d3c46db25995ffd04d0982d38f9f239b2bd8b74e6a618954b56fbd679860d336"
		)
	]
)