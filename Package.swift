...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-4.2.0-rc.34.xcframework.zip",
			checksum: "a096d519913f11de2ed6f8feeb3bf774e6fe2bf1cc21b1aa91f4f829a26615a5"
		)
	]
)