...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-4.2.0-rc.37.xcframework.zip",
			checksum: "62c780c93246a667bfe313dbc38101acd0da82c1847aba4402b3c02be53abf81"
		)
	]
)