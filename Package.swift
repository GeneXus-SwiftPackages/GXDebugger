...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDebugger-1.0.0-beta+20230531050040.xcframework.zip",
			checksum: "b66ec8d364ea595dce8b34bd94ba1c18c5139de88f92877ddf706d38ba60877e"
		)
	]
)