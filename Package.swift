...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-4.0.0-rc.43.xcframework.zip",
			checksum: "9a14aecfa487136c7074c6cc301fe638411f195ba458ca85f8815f22bc71ecee"
		)
	]
)