...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDebugger-1.0.0-beta+20230303092649.xcframework.zip",
			checksum: "c8d85482df068607ba2552a5bc848adeef71c0524d1661a9c17a2e7c718674b7"
		)
	]
)