...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-1.4.0-rc.10.xcframework.zip",
			checksum: "54581d91b0add3956099a14d99e0a99d28bce225b2cf4daa74b0bdca2a1951b0"
		)
	]
)