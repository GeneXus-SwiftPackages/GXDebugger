...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDebugger-1.0.0-beta+20230324153906.xcframework.zip",
			checksum: "c6daba12228dc68ac0a67f50965be2b5fb9e8d8f5c3d67a4d43d40523f0b3350"
		)
	]
)