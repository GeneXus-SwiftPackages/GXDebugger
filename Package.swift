...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-2.1.0-rc.25.xcframework.zip",
			checksum: "aac05762817c9d42752006c8201cc737060eae06242c692246e245963fb48476"
		)
	]
)