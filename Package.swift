...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-2.0.0-rc.32.xcframework.zip",
			checksum: "bf6c206263f210b06de386ce75d3accb5e426166c55f6d3d9724bb7248964fd4"
		)
	]
)