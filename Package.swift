...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-4.1.0-rc.24.xcframework.zip",
			checksum: "4f522649d6b69dacf853207a86e9e7c7bed35ce0190dac658cee96d9f38c6a65"
		)
	]
)