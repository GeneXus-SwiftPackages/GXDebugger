...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDebugger-1.0.0-beta+20230420132651.xcframework.zip",
			checksum: "c9f0fbbf1f4d99e0687fb2bb138c062cb3dbd4e9d8a3d6dc5c63a18b2be14ed8"
		)
	]
)