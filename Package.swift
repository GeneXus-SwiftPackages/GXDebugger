...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-1.5.0-rc.28.xcframework.zip",
			checksum: "42968bc83300caf69db063ece3e4d282259984553d156ba9def03d1ffbf7a95b"
		)
	]
)