...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-3.2.0-rc.11.xcframework.zip",
			checksum: "65a0c890389faca0014f4b466c933c750a68ec4803b66b2b0966bd265d03dcb6"
		)
	]
)