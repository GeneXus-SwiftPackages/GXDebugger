...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-4.1.0-rc.14.xcframework.zip",
			checksum: "c9bc6fcb7711383061ee8c109af2609cdd514cbd9d52e932ce7ab3d87d8650e2"
		)
	]
)