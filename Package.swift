...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-2.0.0-rc.34.xcframework.zip",
			checksum: "70aa1fef1e35c7edf7161b7c207131ef1a9389d4deeaf496f4331718ac8e3eb0"
		)
	]
)