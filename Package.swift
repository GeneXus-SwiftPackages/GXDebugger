...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/beta/GXDebugger-1.0.0-beta+20230309150554.xcframework.zip",
			checksum: "f3ffd719efd1f8d81d3c09aaa3e3bd4ea928fd77dcfc2b49cfb671cd523bdec3"
		)
	]
)