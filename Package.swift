...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXDebugger",
			url: "https://pkgs.genexus.dev/iOS/preview/GXDebugger-4.2.0-rc.20.xcframework.zip",
			checksum: "521755eb89a078ad1d5b8a213e7932fc1ce65527c7cd8c5a2eafcfff74f63b0c"
		)
	]
)